...
var getStatusStatement = function (crop) { return "".concat(crop, "<normal>\uC744 \uC2EC\uC740 \uB18D\uC9C0</normal>"); };
...
var appendOptions = function (options, to) {
    ...
    var opts = [];
    to.querySelectorAll('option').forEach(function (opt) { return opts.push(opt); });
    return opts;
};
/**<============== End Appenders <================*/
/**==============> CropSelection ================>*/
